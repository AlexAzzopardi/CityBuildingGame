...
public class Collision_Detection : MonoBehaviour {
	...
	void OnTriggerEnter (Collider object_collider) {
        if (object_collider.tag == "church" || object_collider.tag == "police_station" || object_collider.tag == "fire_station" || object_collider.tag == "hospital" || object_collider.tag == "house" || object_collider.tag == "road" || object_collider.tag == "forestry" || object_collider.tag == "mine" || object_collider.tag == "warehouse" || object_collider.tag == "market_stall" || object_collider.tag == "farm" || object_collider.tag == "construction")
        {
